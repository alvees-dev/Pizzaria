...
import br.com.magna.customer.CustomerRegistration;
...
public class CustomerInterface {
    ...
    private Pizza pizza = new Pizza("name", 0);
    private Drinks drink = new Drinks("name", 0);
    ...
    private void selectHalfPizza() {
        ...
        do {
            ...
            try {
                ...
                cart.addHalfPizza(pizza.listPizza().get(selectHalf1 - 1),
                        pizza.listPizza().get(selectHalf2 - 1));

                if (selectHalf1 == selectHalf2) {
                    clear();
                    System.out.printf("%nAs pizzas selecionadas são iguais. Por favor, selecione pizzas diferentes.%n%n");
                }
